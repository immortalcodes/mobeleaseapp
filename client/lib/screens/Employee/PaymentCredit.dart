...
String? EMIVal =" ";
TextEditingController _EMIValController =
TextEditingController(text: EMIVal);
  ...
  Future<void> _showAddEmiDialog(BuildContext context) async {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Add EMI',style: TextStyle(color: Color(0xffE96E2B)),),
            ...
            child: ListBody(
              children: <Widget>[
                Column(
                  ...
                  children: [
                    Text("Amount of EMI", style: TextStyle(fontWeight: FontWeight.w500, fontSize:12 )),
                    TextFieldWidget(hint: '\$980', controller: _EMIValController),
                  ],
                ),
                SizedBox(
                  height: 20,
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: Icon(Icons.calendar_today, color: Color(0xffE96E2B),),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        InstallmentsCard(installments: 'Down Payment', date: '03/04/22', price: 5300),
                        InstallmentsCard(installments: '1st EMI', date: '03/04/22', price: 1000),
                        Padding(
                          padding: const EdgeInsets.symmetric(vertical:8.0, horizontal: 16),
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                            ...
                            child: Text(
                              "Add EMI",
                              style: TextStyle(color: Color(0xffE96E2B) ,fontSize: 12,fontWeight: FontWeight.w500),
                            ),
                          )
                        ),
                      ],

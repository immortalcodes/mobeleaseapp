              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text("Date", style: TextStyle(color: Color(0xffE96E2B), fontSize: 10),),
                      Text("Time IST", style: TextStyle(color: Color(0xffE96E2B), fontSize: 10),),
                    ],
                  )
                ],
              ),
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("To", style: TextStyle(color: Color(0xffE96E2B)),),
                        Text("Name"),
                        Text("Mobile No."),
                        Text("Language:French", style: TextStyle(color: Color(0xffE96E2B)),),
                      ],
                    ),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Row(
                            children:[
                              Text("Change Status", style: TextStyle(color: Color(0xffE96E2B)),),
                              Icon(Icons.keyboard_arrow_down_sharp, color: Color(0xffE96E2B),)
                            ]
                          ),
                        ),
                        Row(
                          children: [
                            Text("Sold by:", style: TextStyle(color: Colors.blue),),
                    ...
                    Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.end,
                        children: [
                          ...
                          Text('\$2500',  style: TextStyle(color: Color(0xffE96E2B), fontSize: 12, fontWeight: FontWeight.w600),)
                        ],
                      ),
                    )
                  ],
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(left: 30.0,right: 20.0, top: 8, bottom: 8),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          PaymentTag(Tag: 'Installments',),
                          SizedBox(
                          ...
                          PaymentTag(Tag: 'Amount',),
                          SizedBox(
                            width: MediaQuery.of(context).size.width*0.08,
                          ),
                          PaymentTag(Tag: 'Status',),
                        ],
                      ),
                    ),
                    ReportsInstallmentsCard(installments: 'Down Payment', date: '03/04/22', price: 5300, status: "Paid"),
                    ReportsInstallmentsCard(installments: '2nd EMI', date: '03/04/22', price: 1000, status: "Due"),
                    Container(
                      height: 42,
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                                width: MediaQuery.of(context).size.width*0.2,
                                child: Text('Updates', style: TextStyle(color: Color(0xffE96E2B),fontWeight: FontWeight.w600, fontSize: 10),textAlign: TextAlign.center,)
                            ),
                            SizedBox(
                              width: MediaQuery.of(context).size.width*0.08,
                            ),
                            Text('03/04/23', style: TextStyle(fontWeight: FontWeight.w400, fontSize: 10),),
                            SizedBox(
                              width: MediaQuery.of(context).size.width*0.09,
                            ),
                            Text('\$1000', style: TextStyle(fontWeight: FontWeight.w400, fontSize: 10),),
                            SizedBox(
                              width: MediaQuery.of(context).size.width*0.05,
                            ),
                            Row(
                              children: [
                                Text('Paid Less', style: TextStyle(fontWeight: FontWeight.w400, fontSize: 10),),
                                GestureDetector(
                                  onTap: (){
                                    
                                  },
                                    child: Icon(Icons.keyboard_arrow_down_sharp, color: Color(0xffE96E2B),)
                                )
                              ],
                            ),
                          ],
